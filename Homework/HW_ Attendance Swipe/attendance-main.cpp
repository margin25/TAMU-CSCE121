...
int main()
{
  ...
  do
  {
    ...
    {
    case '1':
      processLoadCourses(school);
      break;
    case '2':
      processLoadStudents(school);
      break;
    case '3':
      processLoadAttendance(school);
      break;
    case '4':
      processOutputAttendanceStudent(school);
      break;
    case '5':
      processOutputAttendanceCourse(school);
      break;
    case '6':
      school.listCourses(cout);
      break;
    case '7':
      school.listStudents(cout);
      break;
    case 'q':
      break; // do nothing
    default:
